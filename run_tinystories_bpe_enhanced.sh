...
export INPUT_PATH="${INPUT_PATH:-data/TinyStoriesV2-GPT4-train.txt}"
export OUTPUT_DIR="${OUTPUT_DIR:-data/tinystories_bpe_10000}"
export VOCAB_SIZE="${VOCAB_SIZE:-10000}"
