...
def run_swiglu(
    ...
    from cs336_basics.nn_feedforward import SwiGLU
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.nn_attention import scaled_dot_product_attention
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.nn_attention import CausalMultiHeadSelfAttention
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.nn_feedforward import silu
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.nn_attention import softmax
